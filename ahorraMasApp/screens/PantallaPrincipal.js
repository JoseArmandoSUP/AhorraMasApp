            ...
            <View style={styles.cardsRow}>
                <View style={[styles.card, styles.cardLeft]}>
                    <Text style={styles.cardLabel}>Gastos mes</Text>
                        <Text style={styles.cardValue}>${(Number(gastosMes) || 0).toFixed(2)}</Text>
                </View>

                <View style={[styles.card, styles.cardRight]}>
                    <Text style={styles.cardLabel}>Ingresos mes</Text>
                        <Text style={styles.cardValue}>${(Number(ingresosMes) || 0).toFixed(2)}</Text>
                </View>
            </View>

            <View style={styles.balanceCard}>
                <Text style={styles.cardLabel}>Balance</Text>
                    <Text style={[styles.cardValue, {color: balanceMes < 0 ? '#c62828' : '#2e7d32'}]}>${(Number(balanceMes) || 0).toFixed(2)}</Text>
            </View>
